...
namespace _6PartConsoleApp
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.ReadLine();
            {
                List<string> mnamelist = new List<string>() {"Adam","Adam", "Eric", "Bob" };
               ...
               foreach (string mname in mnamelist)
                {
                    if (mnamelist2.Contains(mname))
                    {
                        Console.WriteLine(mname + " already exists please try again");
                       
                    }
                    else if (!mnamelist2.Contains(mname))
                    {
                        Console.WriteLine(mname +" has not appeared in then list.");
                        mnamelist2.Add(mname);
                        
                    }
                }
                Console.WriteLine(mnamelist2[0]);//Checks mnamelist2 to make sure names were added
                Console.WriteLine(mnamelist2[1]);//Checks mnamelist2 to make sure names were added
                Console.WriteLine(mnamelist2[2]);//Checks mnamelist2 to make sure names were added
            }
            Console.ReadLine();
        }
    }
